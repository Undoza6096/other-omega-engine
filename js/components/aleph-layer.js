...
<div class="resource">
    <p>You have {{formatNumber(aleph.aleph, 2, 2, 1e9)}} <span class="aleph">ℵ Sim</span></p>
    <p>You get {{formatNumber(aleph.getAlephGain(), 2, 2, 1e9)}} <span class="aleph">ℵ Sim</span> every second</p>
</div>
<div class="boosts">
    ...
    <div v-else>
        <p>You need to go <resource-name :layerid="3"></resource-name> at least once to get <span class="aleph">ℵ simulator</span></p>
    </div>
</div>
<div class="tabs">
