const game = {
    ...
    achievements: [
        ...
        new Achievement("Aleph tt", "Have 1,000 aleph", "&aleph;<sub>TT</sub>", () => game.alephLayer.aleph.gte("1000")),
        new Achievement("Aleph ttt", "Have 1e12 aleph", "&aleph;<sub>TTT</sub>", () => game.alephLayer.aleph.gte("1e12")),
        new Achievement("Aleph tnt", "Have 1e36 aleph", "&aleph;<sub>TNT</sub>", () => game.alephLayer.aleph.gte("1e36")),
        new Achievement("Aleph tqt", "Have 1e57 aleph", "&aleph;<sub>TQT</sub>", () => game.alephLayer.aleph.gte("1e57")),
        new Achievement("Aleph tmt", "Have 1e66 aleph", "&aleph;<sub>TMT</sub>", () => game.alephLayer.aleph.gte("1e66")),
        new Achievement("Aleph gg", "Have 1e75 aleph", "&aleph;<sub>GG</sub>", () => game.alephLayer.aleph.gte("1e75")),
        new Achievement("Aleph-1", "Have 1e90 aleph", "&aleph;<sub>1</sub>", () => game.alephLayer.aleph.gte("1e90")),
