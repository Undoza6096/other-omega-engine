const game = {
    ...
    achievements: [
        ...
        new Achievement("Aleph-group", "Have 1e250 aleph", "&aleph;<sub>2</sub>", () => game.alephLayer.aleph.gte("1e250")),
        ...
        new Achievement("i webl groups mode", "group mods", "↑<sub>↑<sub>2</sub></sub>", () => game.metaLayer.active),
        new Achievement("Idle^nice", "Buy the meta upgrade 3 times", "↑<sub>NICE<sub>", () => game.restackLayer.metaUpgrade.level.gte(3)),
    ...
    secretAchievements: [
        ...
        new Achievement("I MOD", "Go meta and be reborn", "&Omega;", () => game.metaLayer.active),
